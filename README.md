...
- [webpack / webpack](https://github.com/webpack/webpack) 更优秀的打包工具
- [shama / webpack-stream](https://github.com/shama/webpack-stream) 把 Webpack 集成到 Gulp 里去
...
- [gwendall / way.js](https://github.com/gwendall/way.js) 简单轻量的一个双向数据绑定库
...
- [petkaantonov / bluebird](https://github.com/petkaantonov/bluebird) 又一个 promise polyfill
...
- [tildeio / router.js](https://github.com/tildeio/router.js) 轻量级的路由控制器
- [jadejs / jade](https://github.com/jadejs/jade) NodeJS Jade 模板引擎
- [mgcrea / angular-strap](https://github.com/mgcrea/angular-strap) 适用于 Bootstrap 3 的 AngularJS 1.2+ 原生 directives
...
- [aui / font-spider](https://github.com/aui/font-spider) 中文 WebFont 自动化压缩工具
...
- [nuysoft / Mock](https://github.com/nuysoft/Mock) 模拟数据生成器
...
- [creationix / nvm](https://github.com/creationix/nvm) Node 版本管理器
- [nwjs / nw.js](https://github.com/nwjs/nw.js) 使用 Javascript 来写应用，各个平台
...
- [apiaryio / api-blueprint](https://github.com/apiaryio/api-blueprint) 一个面向文档的 API 描述语言
- [servo / servo](https://github.com/servo/servo) Servo 浏览器引擎
- [facebook / css-layout](https://github.com/facebook/css-layout) Javacript 实现的 CSS 布局
...
- [linnovate / mean](https://github.com/linnovate/mean) MEAN (Mongo, Express, Angular, Node) Javascript 全栈开发
- [auth0 / node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) NodeJS 实现的 JSON Web Token
...
- [jlibert / angular-express-bootstrap-sb-admin-seed](https://github.com/jlibert/angular-express-bootstrap-sb-admin-seed) 看名字就知道了
